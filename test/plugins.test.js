...
import { clearCache, manifestPath, pluginsCacheRoot, writeCachedFile, writeJsonAtomic } from "../src/docs/cache.js";
import { DocsError, DocsNotFoundError } from "../src/docs/errors.js";
import { buildPageList } from "../src/docs/fetch-docs.js";
import { buildIndex, saveIndex } from "../src/docs/local-index.js";
import { pageSectionMarkdown } from "../src/docs/page.js";
import {
  buildPluginIndex,
  hasPluginIndex,
  loadPluginPage,
  ...
  searchPlugins,
  writePluginReadme,
} from "../src/docs/plugins.js";
import { runDocsSearch } from "../src/docs/search.js";
...
test("kind=plugin without a plugin index raises a DocsError with a sync hint", async () => {
  await withTempHome(async () => {
    await assert.rejects(
      ...
      (err) => err instanceof DocsError && /ex docs offline/.test(err.hint)
    );
  });
});
