...
import { createTsEditor, type Edit } from "../src/generate/ts-edit.ts";
import type * as TS from "typescript";
import { GenerateError, SeamNotFoundError } from "../src/generate/errors.ts";

const ed = createTsEditor(ts);

function edit(name: string, text: string, fn: (sf: TS.SourceFile, text: string) => { edits: Edit[] }): string {
