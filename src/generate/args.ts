...
const KIND_ALIASES: Record<string, GenerateKind> = {
  a: "actor",
  actor: "actor",
  l: "label",
  label: "label",
...
export const GENERATE_KINDS: readonly GenerateKind[] = ["actor", "label", "scene", "resource", "engine", "material", "update-actor", "spritesheet", "animation"];
