 ...
 */
export const leakedSubscription: Rule = {
  ...
  create(ctx: RuleContext, sf: TS.SourceFile): RuleListeners {
    ...
    const subs: Array<{ node: TS.CallExpression; eventName: string | null; classNode: TS.ClassDeclaration }> = [];
    const offs: Array<{ eventName: string | null; classNode: TS.ClassDeclaration }> = [];

    function eventNameOf(call: TS.CallExpression): string | null {
