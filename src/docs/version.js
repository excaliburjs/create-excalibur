...
import { DEFAULT_REF } from "./constants.js";
 ...
 */
export function findProjectPackage(cwd = process.cwd()) {
 ...
 * @returns {{ version: string | null, source: 'node_modules' | 'package.json' | null, range?: string }}
 */
export function detectExcaliburVersion(cwd = process.cwd()) {
 ...
 */
export function refForVersion(version) {
