...
export function hasMarker(text: string, line: number, id: string): boolean {
 ...
 *
 * Returns projectDir-relative files modified.
 */
...
export function insertBreadcrumbs(projectDir: string, sites: BreadcrumbSite[]): string[] {
  const byFile = new Map<string, BreadcrumbSite[]>();
